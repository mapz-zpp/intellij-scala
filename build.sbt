...
lazy val runtimeDependencies = project.in(file("target/tools/runtime-dependencies"))
  ...
  .settings(
    ...
    dynamicDependencies := Seq(
      ...
      binaryDep("ch.epfl.scala", "scala-expression-compiler", "3.4.1", Versions.scalaExpressionCompiler) -> "debugger/scala-expression-compiler_3.4.1.jar",
      ...
      binaryDep("ch.epfl.scala", "scala-expression-compiler", "3.3.3", Versions.scalaExpressionCompiler) -> "debugger/scala-expression-compiler_3.3.3.jar",
