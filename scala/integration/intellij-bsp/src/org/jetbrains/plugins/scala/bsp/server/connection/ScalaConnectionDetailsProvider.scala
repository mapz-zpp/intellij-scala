...
class ScalaConnectionDetailsProvider extends ConnectionDetailsProviderExtensionJavaShim {
  ...
  override def provideNewConnectionDetails(project: Project, currentDetails: BspConnectionDetails): BspConnectionDetails = {
    ...
    val connectionFile = getChild(projectRootPath, List.apply(".bsp", "sbt.json")) match {
